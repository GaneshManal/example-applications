...
public class HostNwInterface extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {

    private static final long serialVersionUID = -4372457208513393133L;

    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HostNwInterface\",\"namespace\":\"com.cisco.pnda\",\"fields\":[{\"name\":\"source\",\"type\":\"string\"}, {\"name\":\"timestamp\",\"type\":\"long\"}, {\"name\":\"rawData\",\"type\":\"string\"}]}");
    ...
    */
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
        case 0: source = (String)value$.toString(); break;
        case 1: timestamp = (Long)value$; break;
        case 2: rawData = (String)value$.toString(); break;
        default: throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
    }
     ...
     * @return A new network interface RecordBuilder
     */
    public static com.cisco.pnda.examples.HostNwInterface.Builder newBuilder(com.cisco.pnda.examples.HostNwInterface.Builder other) {
        return new com.cisco.pnda.examples.HostNwInterface.Builder(other);
    }

    /**
     * Creates a new HostNwInterface RecordBuilder by copying an existing HostNwInterface instance.
     * @param other The existing instance to copy.
     * @return A new HostNwInterface RecordBuilder
     */
    public static com.cisco.pnda.examples.HostNwInterface.Builder newBuilder(com.cisco.pnda.examples.HostNwInterface other) {
        return new com.cisco.pnda.examples.HostNwInterface.Builder(other);
    }
        ...
        */
        ...
        public HostNwInterface build() {
            try {
                ...
                record.source = fieldSetFlags()[0] ? this.source : (String) defaultValue(fields()[0]);
